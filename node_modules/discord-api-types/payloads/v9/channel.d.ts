...
export interface APIGuildTextChannel<T extends ChannelType.GuildForum | ChannelType.GuildMedia | GuildTextChannelType> extends Omit<APITextBasedChannel<T>, 'name'>, APISortableChannel, APIGuildChannel<T> {
    /**
...
export interface APIVoiceChannelBase<T extends ChannelType> extends APIGuildChannel<T>, APISortableChannel, Omit<APITextBasedChannel<T>, 'last_pin_timestamp' | 'name'> {
    /**
...
export interface APIThreadChannel<Type extends ThreadChannelType = ThreadChannelType> extends Omit<APITextBasedChannel<Type>, 'name'>, APIGuildChannel<Type> {
    /**
